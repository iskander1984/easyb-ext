...
class JMSCategories{
    ...
    static void sendMessage(Object self, String inputQueueName, String message){
        self.jmsTemplate.convertAndSend(inputQueueName, message)
    }
    
    static String receiveMessage(Object self, String outputQueueName, long timeout = 0){
        self.jmsTemplate.setReceiveTimeout(timeout)
        self.jmsTemplate.receiveAndConvert(outputQueueName)
    }
}