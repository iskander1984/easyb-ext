        ...
        <fo:table-body>
          <fo:table-row>
            <fo:table-cell text-align="center">
              <fo:block>
                <fo:external-graphic src="file:images/logo_easyb.jpg"/>
              </fo:block>
              <fo:block font-family="Helvetica" font-size="18pt" space-after="5mm" space-before="10mm">
                <xsl:value-of select="bookinfo/title"/>
              </fo:block>
              <fo:block font-family="Helvetica" font-size="12pt" space-after="5mm">
                Publish Date
  ...
  <xsl:template name="footer.content">
    ...
    <xsl:choose>
      ...
      <xsl:when test="$position = 'center'">
        <fo:block font-size="8pt">
          <xsl:value-of select="/book/bookinfo/copyright"/>
        </fo:block>
      </xsl:when>
